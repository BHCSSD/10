...
// This if statement ask if your mouse is inside the sprote and the mouse is clicked. 
  if(hitBox(sprite.cx, sprite.cy, sprite.size, sprite.size) == true){ 
    circle(100,100,100)// what do you want to do in if your mouse clicks in the sprite. 
  }
  
  
}
//make sure to copy this to the very bottom of your code. 
