...
> 
> These commands **pause the program** and wait for user input, which can cause your sketch to **freeze** since `draw()` runs many times per second.
>
> You use them inside `setup()` or with  `mousePressed()` or `keyPressed()`.
>
