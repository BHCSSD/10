...
function draw() {
    line(0, lineY, mouseX, mouseY); // Notice I used variables instead of numbers

    //1. Add in code to make line move down automatically


   //2. Change the colours of the line with random()

   //3. Draw Circles with random() x,y

   //4. make the colours of the circles change randomly, make them transparent 
...
function mousePressed() {
    //5. add a way to reset the background
