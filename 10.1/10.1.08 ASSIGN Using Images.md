...
1. Choose three characters **and** one background from a cartoon you like.
  * they must have transperent background
  * 1 image must be a gif 
3. Save them to your `images` folder.
4. Use `image()` to display all four images on your canvas.
5. Adjust each image’s position and size so your scene looks balanced.
...
1. add a title or quote to your canvas 
2. Load and use a font on that title.
3. Change the colour of the title to something not black or white. 
