...
> [!TIP]
> If you want to wrap your text to a new line, you can use the new line indicator
>  `\n`
...
## Part 3: Give Them a Rating

1. Add a line of text at the bottom:
   `"Press the 'Up arrow' key to test your score."`

2. Add another `else if` block in your `keyPressed()` to deal with the logic of the rating system
...
3. Create a **3-level rating system**:
   ...
   * **Full marks only** if it appears **only when the user presses `Up arrow`**.
     * **BIG HINT**, look at `10.2.02 Demo: Music Comp` for how it only showed the text after you finished the text inputs. 
