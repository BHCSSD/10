...
function draw() {
 ...
 rect(0, 550, 500, 50);
 fill(0);
 snowText(550, 500) // hmm look at me... this is a function, its special

}//end of  draw


// this is a function that I made. It lets me make my own code blocks.
function snowText(x, y) {  // the x and y control where is is
 fill(200);
 noStroke();
 rect(0, x, y, 50);
 fill(0);
 textSize(big);
 textAlign(CENTER);
 text("A fine winter's day!", width / 2, 590);  // this is the text we edit

// note this function is made here... but "called" (used) in draw. 
}
