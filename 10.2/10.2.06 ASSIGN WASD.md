...
Set the canvas size to `300, 300`. <- why? so it is quicker for me to mark.
...
4. Research how to make the square move **continuously** instead of one step at a time.
   * (Hint you will need to break MVC for this part)
      * aka you need to move where the `if` blocks are located
        * aka [look here](https://p5js.org/reference/p5/keyCode/)  - old school not working in 2.o
        * also or https://p5js.org/reference/p5/keyIsDown/ - use a string, not keyCode
